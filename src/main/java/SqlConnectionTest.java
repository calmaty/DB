...
public class SqlConnectionTest {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < 20; i++) {
            timer.reset();
            timer.start();
            String query = "USE Social_Network;\n" +
                    "SELECT name\n" +
                    "FROM Person\n" +
        ...
        for (int i = 0; i < 20; i++) {
            ...
            String query = "use Social_Network;\n" +
                    ...
                    "select target_node_id from Endorses where source_node_id in (\n" +
                    "select target_node_id from Endorses where source_node_id = " + rndNodes[i] +"));";
